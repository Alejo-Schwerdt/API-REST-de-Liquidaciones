...
API REST complementaria a la [API de Operaciones]([[https://github.com/Alejo-Schwerdt/API-REST-Transportista]](https://github.com/Alejo-Schwerdt/API-REST-de-Transportistas))), desarrollada con Spring Boot. Gestiona el proceso de liquidación de pagos a camioneros, aplicando retenciones, descuentos y registrando los pagos realizados.
